...
CREATE TABLE IF NOT EXISTS portal_backups (id CHAR(36) PRIMARY KEY, name VARCHAR(190) NOT NULL, backup_json LONGTEXT NOT NULL, backup_format VARCHAR(20) NOT NULL DEFAULT 'json', file_path VARCHAR(700) NULL, size_bytes BIGINT UNSIGNED NOT NULL DEFAULT 0, created_by CHAR(36) NULL, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, INDEX idx_portal_backups_created (created_at));
